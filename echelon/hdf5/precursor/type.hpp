...
#ifndef ECHELON_HDF5_PRECURSOR_TYPE_HPP
#define ECHELON_HDF5_PRECURSOR_TYPE_HPP
...
public:
    ...
    void insert_member(const std::string& name, std::size_t offset, const type& field_type);
