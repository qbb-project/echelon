...
#ifndef ECHELON_HDF5_ATTRIBUTE_REPOSITORY_HPP
#define ECHELON_HDF5_ATTRIBUTE_REPOSITORY_HPP
...
{
public:
    non_existing_attribute_exception(std::string what_) : what_(std::move(what_))
    {
    }
...
{
public:
    explicit attribute_repository(Parent parent_) : parent_(std::move(parent_))
    {
    }
    ...
    {
        return hdf5::precursor::is_attribute_existing(hdf5::precursor::object(parent_.id()), name);
    }
