...
#ifndef ECHELON_HDF5_ADAPT_TYPE_HPP
#define ECHELON_HDF5_ADAPT_TYPE_HPP
...
#define ECHELON_PROCESS_MEMBER_LIST(TYPE_NAME, MEMBERS)                                            \
    {                                                                                              \
        ECHELON_TUPLE_TO_VARIADIC(BOOST_PP_SEQ_TO_TUPLE(                                           \
            BOOST_PP_SEQ_TRANSFORM(ECHELON_CREATE_ID_OFFSET_PAIR, TYPE_NAME, MEMBERS)))            \
    }

#define ECHELON_GET_MEMBER_TYPE(d, data, value) decltype(data::value)

#define ECHELON_GET_MEMBER_TYPES(TYPE_NAME, MEMBERS)                                               \
    ECHELON_TUPLE_TO_VARIADIC(BOOST_PP_SEQ_TO_TUPLE(                                               \
        BOOST_PP_SEQ_TRANSFORM(ECHELON_GET_MEMBER_TYPE, TYPE_NAME, MEMBERS)))
...
#define ECHELON_ADAPT_COMPOUND_TYPE(TYPE_NAME, MEMBERS)                                            \
    ...
    {                                                                                              \
        ...
        static constexpr std::size_t num_members = std::tuple_size<member_types>::value;           \
    };                                                                                             \
                                                                                                   \
    template <>                                                                                    \
...
#define ECHELON_PROCESS_PACKED_MEMBER_LIST(TYPE_NAME, MEMBERS)                                     \
    {                                                                                              \
        ECHELON_TUPLE_TO_VARIADIC(BOOST_PP_SEQ_TO_TUPLE(                                           \
            BOOST_PP_SEQ_TRANSFORM(ECHELON_CREATE_ID_SIZE_PAIR, TYPE_NAME, MEMBERS)))              \
    }

#define ECHELON_GET_PACKED_MEMBER_TYPE__(d, data, TYPE, NAME) TYPE
...
#define ECHELON_GET_PACKED_MEMBER_TYPES(MEMBERS)                                                   \
    ECHELON_TUPLE_TO_VARIADIC(                                                                     \
        BOOST_PP_SEQ_TO_TUPLE(BOOST_PP_SEQ_TRANSFORM(ECHELON_GET_PACKED_MEMBER_TYPE, _, MEMBERS)))
