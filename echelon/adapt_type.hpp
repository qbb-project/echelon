    ...
    {                                                                          \
        ECHELON_TUPLE_TO_VARIADIC(                                             \
            BOOST_PP_SEQ_TO_TUPLE(BOOST_PP_SEQ_TRANSFORM(                      \
                ECHELON_CREATE_ID_OFFSET_PAIR, TYPE_NAME, MEMBERS)))           \
    }
...
#define ECHELON_ADAPT_COMPOUND_TYPE(TYPE_NAME, MEMBERS)                        \
    ...
    {                                                                          \
        ...
        typedef std::tuple<ECHELON_GET_MEMBER_TYPES(TYPE_NAME, MEMBERS)>       \
        member_types;                                                          \
...
#define ECHELON_PROCESS_PACKED_MEMBER_LIST(TYPE_NAME, MEMBERS)                 \
    {                                                                          \
        ECHELON_TUPLE_TO_VARIADIC(                                             \
            BOOST_PP_SEQ_TO_TUPLE(BOOST_PP_SEQ_TRANSFORM(                      \
                ECHELON_CREATE_ID_SIZE_PAIR, TYPE_NAME, MEMBERS)))             \
    }
...
#define ECHELON_GET_PACKED_MEMBER_TYPES(MEMBERS)                               \
    ECHELON_TUPLE_TO_VARIADIC(BOOST_PP_SEQ_TO_TUPLE(                           \
        BOOST_PP_SEQ_TRANSFORM(ECHELON_GET_PACKED_MEMBER_TYPE, _, MEMBERS)))
...
#define ECHELON_ADAPT_PACKED_COMPOUND_TYPE(TYPE_NAME, MEMBERS)                 \
    ...
    {                                                                          \
        ...
        typedef std::tuple<ECHELON_GET_PACKED_MEMBER_TYPES(MEMBERS)>           \
        member_types;                                                          \
        static const char* name()                                              \
        {                                                                      \
            return BOOST_PP_STRINGIZE(TYPE_NAME);                              \
