...
type::type(const type& other) : type_id_(other.id()), is_transient_(other.is_transient_)
{
    if (is_transient_)
    {
...
void type::insert_member(const std::string& name, std::size_t offset, const type& field_type)
{
