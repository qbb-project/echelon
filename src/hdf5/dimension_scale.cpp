...
void dimension_scale::write(const type& mem_type, const dataspace& mem_space, const dataspace& file_space,
                            const property_list& xfer_plist, const void* buf)
{
    underlying_dataset_.write(mem_type,mem_space,file_space,xfer_plist,buf);
}

void dimension_scale::read(const type& mem_type, const dataspace& mem_space, const dataspace& file_space,
