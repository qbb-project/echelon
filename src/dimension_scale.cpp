                                 ...
                                 const std::string& scale_name)
{
    file associated_file(
        associated_dataset.get_native_handle().associated_file());
    ...
    std::string unique_id = generate_unique_identifier(
        associated_dataset.get_native_handle().name());
    ...
    dim_scale_ =
        hdf5::dimension_scale(this_datasets_dimension_scales.id(), dataset_name,
